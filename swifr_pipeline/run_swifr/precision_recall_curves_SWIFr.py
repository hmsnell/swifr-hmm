...
plt.plot(precision1, recall1, c='orange', label='SWIFr')
...
plt.title('Precision Recall Curve for Neutral vs. Sweep') # {}, {}, selcoeff {}, {} generations after ben. mutation'.format(titsce,cond,sel,titgen))
