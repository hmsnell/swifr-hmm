...
plt.plot(fpr1, tpr1, c='orange', label='SWIFr')
...
plt.xlim(0, 0.25)
plt.ylim(0.5, 1.0)
plt.legend(['SWIFr', 'DDAF', 'nSL', 'iHS', 'FST'])
plt.title('ROC Curve for Neutral vs. Sweep') # {}, {}, selcoeff {}, {} generations after ben. mutation'.format(titsce,cond,sel,titgen))
#plt.savefig("ROC.sce{}.S0_{}.{}_gens.{}.pdf".format(titsce,sel,titgen,cond), format="pdf")

file_name = os.path.join(output_folder, "ROC.20-30kya_allselcoeffs.pdf")
